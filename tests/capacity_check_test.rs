...
fn test_tree_with_drop_tracking() {
    ...
    
    {
        ...
        println!("Inserted 10 items, counter: {}", counter.load(Ordering::SeqCst));
        ...
        println!("Removed 3 items, counter: {}", counter.load(Ordering::SeqCst));
    ...
    assert_eq!(final_count, 0, "Memory leak detected: {} items not dropped", final_count);
}
